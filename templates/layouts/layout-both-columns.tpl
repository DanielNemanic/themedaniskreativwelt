...
<html lang="{$language.iso_code}">
  ...
  <body id="{$page.page_name}" class="{$page.body_classes|classnames}">
    ...
    <div class="uk-section uk-section-xsmall uk-padding-remove-top" >
        ...
        <div class="uk-container uk-container-xlarge uk-card uk-card-default" style="padding-bottom: 20px;">
            ...
            <div uk-grid>
              ...
              {block name="content_wrapper"}
                <div id="content-wrapper" class="uk-width-1-1 uk-width-3-4@s">
              ...
              {block name="right_column"}
                <div id="right-column" class="uk-width-1-1">
                  {if $page.page_name == 'product'}
